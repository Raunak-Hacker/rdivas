...
<img src="https://selvia.in/media/wysiwyg/discount.png" alt=""> <p>Special offer: Pay online and get 5% OFF</p>
</div>
...
export default {
  ...
  async created() {
    try {
      ...
      // this.imgId = this.images[0];
      // this.mimg = this.images[0];
      this.imgId = 0;
      this.mimg = this.images[0];
  ...
  methods: {
    ...
    prev() {
      this.imgId--;
        ...
        this.mimg = this.images[this.imgId];
